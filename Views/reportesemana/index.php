...
<h4 class="mb-3">Reporte semanal</h4>

<div class="row g-2 mb-3">
  <div class="col-auto">
    <input type="date" id="fechaIni" class="form-control" value="<?=date('Y-m-d');?>">
  </div>
  <div class="col-auto">
...
<script src="<?=base_url?>Assets/js/pages/reporte_semana.js"></script>
