...
<button class="btn btn-outline-primary mb-2" type="button" onclick="frmTipo();"><i class="fas fa-plus"></i></button>

<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover display responsive nowrap" id="tblTipos" style="width: 100%;">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Nombre</th>
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formulario" onsubmit="registrarTipo(event);" autocomplete="off">
...
<script src="<?php echo base_url . 'Assets/js/pages/tipos.js'; ?>"></script>
