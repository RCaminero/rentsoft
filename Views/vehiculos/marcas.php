...
<button class="btn btn-outline-primary mb-2" type="button" onclick="frmMarca();"><i class="fas fa-plus"></i></button>

<div class="card">
    <div class="card-body">
        <table class="table table-bordered table-hover display responsive nowrap" id="tblMarcas" style="width: 100%;">
            <thead>
                <tr>
                    <th>Id</th>
                    <th>Nombre</th>
            ...
            <form id="formulario" onsubmit="registrarMarca(event);" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El nombre es requerido">
                        ...
                        <input id="nombre" class="form-control" type="text" style="text-transform: capitalize;" name="nombre" placeholder="Nombre de la marca" required>
...
<script src="<?php echo base_url . 'Assets/js/pages/marcas.js'; ?>"></script>
